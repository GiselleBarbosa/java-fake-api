package com.barbosa.fakeapi.infrastructure.exceptions.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handlerUnprocessableEntity(UnprocessableEntityException ex,
